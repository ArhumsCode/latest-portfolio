...
Command: npx gltfjsx@6.5.3 scene-transformed.glb --transform 
Files: scene-transformed.glb [57.65MB] > C:\Users\arhum\Downloads\a_windy_day\scene-transformed-transformed.glb [57.65MB] (0%)
...
const Room = (props) => {
  ...
  const { nodes, materials, animations } = useGLTF('/models/scene-transformed-transformed.glb')
...
useGLTF.preload('/models/scene-transformed-transformed.glb')
